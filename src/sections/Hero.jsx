        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-xl mb-10 leading-relaxed">
              I'm <span className="font-bold text-slate-900 italic">Andro Belgica</span>, a Technical Specialist with a passion for software development and complex system troubleshooting. Turning technical challenges into seamless user experiences.
            </p>
          ...
          >
            <div className="relative z-10 glass-dark p-8 rounded-[2rem] shadow-2xl border border-white/20 transform rotate-1">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div className="text-xs text-white/40 font-mono">andro_profile.js</div>
              </div>
              
              <div className="space-y-6 font-mono text-sm sm:text-base">
                <div className="flex items-start space-x-4 group">
                  <Terminal className="text-primary-400 mt-1 flex-shrink-0" size={20} />
                  <div>
                    <span className="text-primary-300">Software</span>
                    <p className="text-white/60">C#, Python, React, PHP</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <Cpu className="text-purple-400 mt-1 flex-shrink-0" size={20} />
                  <div>
                    <span className="text-purple-300">Hardware</span>
                    <p className="text-white/60">Servicing & Maintenance</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <Zap className="text-yellow-400 mt-1 flex-shrink-0" size={20} />
                  <div>
                    <span className="text-yellow-300">AI / Tech</span>
                    <p className="text-white/60">Workflow Automation Specialist</p>
                  </div>
                </div>
              </div>
            </div>
